...
Sidebar.Settings = function ( editor ) {
	...
	var options = {
		'static/css/light.css': strings.getKey( 'sidebar/settings/theme/light' ),
		'static/css/dark.css': strings.getKey( 'sidebar/settings/theme/dark' )
	};
	...
	if ( config.getKey( 'theme' ) !== undefined ) {
		...
		console.log('saved theme is '+config.getKey( 'theme' ));
