...
var Strings = function ( config ) {
	...
	var values = {
		...
		en: {
			...
			'menubar/file/importdxf': 'Import DXF...',
			...
			'menubar/view': 'View',
			'menubar/view/toggle_node_labels': 'Toggle Node IDs',
			'menubar/view/toggle_beam_labels': 'Toggle Beam IDs',
			'menubar/view/toggle_column_labels': 'Toggle Column IDs',
			'menubar/view/toggle_grid': 'Toggle Grid Visibility',
			...
			'sidebar/project': 'Nodes',
			'sidebar/project/title': 'Title',
			'sidebar/project/editable': 'Editable',
			'sidebar/project/x': 'x',
			'sidebar/project/x': 'y',
			'sidebar/project/x': 'z',
			'sidebar/project/nodei': 'Node i',
			'sidebar/project/nodej': 'Node j',
			...
			'sidebar/createElement/nodeI': 'Node i',
			'sidebar/createElement/nodeJ': 'Node j',
